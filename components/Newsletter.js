      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 opacity-30">
          {[...Array(20)].map((_, i) => {
            ...
            const positions = [
              { left: 25, top: 15 }, { left: 70, top: 35 }, { left: 85, top: 70 }, { left: 40, top: 25 },
              { left: 15, top: 80 }, { left: 60, top: 45 }, { left: 80, top: 60 }, { left: 35, top: 85 },
              { left: 55, top: 20 }, { left: 90, top: 40 }, { left: 20, top: 75 }, { left: 75, top: 55 },
              { left: 45, top: 90 }, { left: 10, top: 30 }, { left: 65, top: 10 }, { left: 95, top: 65 },
              { left: 30, top: 50 }, { left: 85, top: 30 }, { left: 50, top: 85 }, { left: 75, top: 20 }
            ];
            const delays = [0.1, 0.8, 1.5, 0.4, 1.2, 2.1, 0.7, 1.9, 0.3, 2.4, 0.9, 1.6, 2.8, 0.5, 1.3, 2.2, 0.6, 1.8, 2.5, 0.2];
            const durations = [2.3, 3.8, 2.9, 4.2, 2.7, 3.5, 4.1, 2.4, 3.2, 3.9, 2.6, 3.3, 4.5, 2.8, 3.1, 3.7, 2.5, 3.4, 4.3, 2.2];
