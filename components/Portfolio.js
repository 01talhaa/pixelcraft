      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <div className="inline-block bg-gradient-to-r from-purple-100 to-pink-100 px-4 py-2 rounded-full mb-6">
            <span className="text-purple-600 font-semibold">Our Portfolio</span>
          </div>
          ...
          {filteredProjects.map((project, index) => (
            ...
            >
              ...
              <div className="relative overflow-hidden">
                ...
                >
                  <button className="bg-white text-gray-900 px-6 py-3 rounded-full font-semibold transform scale-90 group-hover:scale-100 transition-transform duration-300 shadow-lg">
                    View Project
                  </button>
                </div>
              </div>
