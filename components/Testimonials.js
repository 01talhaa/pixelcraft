      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <div className="inline-block bg-gradient-to-r from-yellow-100 to-amber-100 px-4 py-2 rounded-full mb-6">
            <span className="text-amber-700 font-semibold">Client Testimonials</span>
          </div>
        ...
        >
          <div className="max-w-4xl mx-auto">
            {/* Main Testimonial */}
            <div className="bg-gradient-to-br from-yellow-900/20 to-amber-900/20 rounded-3xl p-8 md:p-12 relative overflow-hidden border border-gray-700">
              {/* Quote Icon */}
              <div className="absolute top-8 left-8 text-6xl text-yellow-400/30 font-serif">"</div>
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center justify-center">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-gray-400 text-xs mt-1">Project: {testimonials[currentTestimonial].project}</p>
                  </div>
                </div>
              </div>

              {/* Background Decoration */}
              <div className="absolute -bottom-4 -right-4 w-32 h-32 bg-gradient-to-br from-yellow-400/20 to-amber-400/20 rounded-full opacity-50"></div>
              <div className="absolute -top-4 -left-4 w-24 h-24 bg-gradient-to-br from-amber-400/20 to-yellow-400/20 rounded-full opacity-50"></div>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              <div key={index} className="group">
                <div className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-yellow-400 to-amber-500 bg-clip-text text-transparent mb-2 group-hover:scale-110 transition-transform duration-300">
                  {stat.number}
                </div>
