  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <div className="bg-gray-800/50 backdrop-blur-lg rounded-3xl p-8 md:p-12 border border-gray-700">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <p className="text-yellow-300 text-lg mb-4">Client: {upcomingProjects[currentProject].client}</p>
                ...
                <div className="flex flex-wrap gap-3 mb-8">
                  {upcomingProjects[currentProject].tags.map((tag, index) => (
                    <span
                      key={index}
                      className="px-4 py-2 bg-gray-700/50 backdrop-blur-sm text-white/80 text-sm rounded-full border border-gray-600"
                    >
                      {tag}
                    </span>
                  ))}
              ...
              <div className="relative">
                <div className="relative bg-gradient-to-br from-gray-700/30 to-gray-800/30 rounded-2xl p-6 backdrop-blur-sm border border-gray-600">
                  <img
                  ...
                  {/* Overlay Effect */}
                  <div className="absolute inset-6 bg-gradient-to-t from-black/50 to-transparent rounded-xl"></div>
                </div>

                {/* Floating Elements */}
                <div className="absolute -top-4 -right-4 w-16 h-16 bg-gradient-to-br from-yellow-400 to-amber-500 rounded-full animate-bounce opacity-80"></div>
                <div
                  className="absolute -bottom-4 -left-4 w-12 h-12 bg-gradient-to-br from-amber-400 to-yellow-500 rounded-full animate-bounce opacity-80"
